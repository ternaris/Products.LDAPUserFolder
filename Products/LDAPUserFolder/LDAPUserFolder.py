...
class LDAPUserFolder(BasicUserFolder):
    ...
    def prefetchUsersByIds(self, ids):
        ...
        prefetched_users = self.prefetched_users
        def uncached(id):
        ...
        self.prefetched_users.update(zip(ids, (False for i in range(len(ids)))))
    ...
    def getUserById(self, id, default=_marker):
        ...
        user = self.prefetched_users.get(id)
        if user is False:
            return
